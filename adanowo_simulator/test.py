...
def main(configuration: DictConfig):
    ...
    state_manager = StateManager(config.process_setup, action_type=0)
    ...
    for _ in range(100):
        ...
        env.step(np.random.uniform(low=0.0, high=0.5, size=env.env.state_manager.n_controls))  # for action_type == absolute
